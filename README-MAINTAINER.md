...
- name the file like `2020-12-19-platform-stm32f4discovery-v0-1-0-released.md`
- name the post like: **µOS++ platform-stm32f4discovery v0.1.0 released**
...
- paste the release name like **µOS++ platform-stm32f4discovery v0.1.0 released**
