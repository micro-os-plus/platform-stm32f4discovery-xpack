...
```sh
rm -rf ~/Work/micro-os-plus/platform-stm32f4discovery-xpack.git && \
mkdir -p ~/Work/micro-os-plus && \
git clone \
  https://github.com/micro-os-plus/platform-stm32f4discovery-xpack.git \
  ~/Work/micro-os-plus/platform-stm32f4discovery-xpack.git
```
...
In the `micro-os-plus/platform-stm32f4discovery-xpack` Git repo:
...
- <https://github.com/micro-os-plus/platform-stm32f4discovery-xpack/issues/>
...
```sh
xpm run install-all -C ~/Work/micro-os-plus/platform-stm32f4discovery-xpack.git
xpm run test-all -C ~/Work/micro-os-plus/platform-stm32f4discovery-xpack.git
```
